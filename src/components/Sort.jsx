...
function Sort(/*{ value, onChangeSort }*/) {
    ...
    // Скрываем лист сортировки при клике вне области и делаем UnMount-размонтирование(очищаем обработчик событий ) на click
    ...
    return (
        <div ref={sortRef} className="sort">
            <div className="sort__label">
                ...
                <b>Сортировка по:</b>
                <span onClick={() => setOpen(!open)}>{sortProperty.name}</span>
            </div>
            {open && (
